        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Commisioning_Date = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPowerOutput = table.Column<double>(type: "REAL", nullable: false),
                    TotalPowerRating = table.Column<double>(type: "REAL", nullable: false),
                    Efficiency = table.Column<double>(type: "REAL", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SolarInstallationReports", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    TiltAngle = table.Column<double>(type: "REAL", nullable: false),
                    MaxTiltAngle = table.Column<double>(type: "REAL", nullable: false),
                    Latitude = table.Column<double>(type: "REAL", nullable: false),
                    Longitude = table.Column<double>(type: "REAL", nullable: false),
                    PowerRating = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SolarIntensity = table.Column<double>(type: "REAL", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SolarPanelReports", x => x.Id);
                    table.ForeignKey(
